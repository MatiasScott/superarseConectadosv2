...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const estadoManual = {
            ultimoNoCaducado: estadoSelect.value === "INACTIVO" ? "INACTIVO" : "ACTIVO"
        };

        estadoSelect.addEventListener("change", function() {
            if (estadoSelect.value !== "CADUCADO") {
                estadoManual.ultimoNoCaducado = estadoSelect.value;
            }
        });
        ...
        function actualizarEstadoBadge() {
            ...
            if (diffDays < 0) {
                ...
                estadoBadge.classList.remove("hidden");
                if (estadoSelect.value === "CADUCADO") estadoSelect.value = estadoManual.ultimoNoCaducado;
            }
        }
        fechaInicio.addEventListener("change", actualizarEstadoBadge);
        fechaFin.addEventListener("change", actualizarEstadoBadge);
        fechaFin.addEventListener("input", actualizarEstadoBadge);
