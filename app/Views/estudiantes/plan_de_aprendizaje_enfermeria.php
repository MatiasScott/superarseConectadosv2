    ...
    <div class="container">
        ...
        <div class="document-header">
            ...
            <div class="header-title">
                <h1>Gestión de Prácticas Pre Profesionales laborales4</h1>
        ...
        <form action="<?php echo $basePath; ?>/estudiante/generar-plan-aprendizaje-pdf" method="POST" id="planForm">
                            ...
                            <table style="width: 100%; border: none;">
                                <tr>
                                    ...
                                    <td style="border: none; padding: 0 0 0 10px; width: 50%;">
                                        <strong>Número de total de horas:</strong> <span style="display: inline-block; margin-left: 5px; font-weight: 600;">240</span>
            ...
            <div class="form-section">
                ...
                <div class="objective-text">
                    Aplicar los conocimientos de la carrera de Enfermería Veterinaria mediante la ejecución de actividades técnicas en la atención, cuidado y apoyo clínico del paciente animal en un entorno laboral real, bajo supervisión, fortaleciendo capacidades profesionales, bioseguridad, ética y comunicación, en coherencia con el perfil de egreso.
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <table class="results-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><strong>RA1.</strong> Preparar al paciente y ejecutar técnicas básicas de enfermería veterinaria (curaciones, vendajes, férulas) y administración de medicamentos vía oral/medicamentos conforme prescripción, bajo supervisión.</td>
                            <td>A1, A2, A3</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ra2" value="1"></td>
                            <td><strong>RA2.</strong> Asistir al médico veterinario en procedimientos quirúrgicos, técnicas de diagnóstico de laboratorio y por imágenes.</td>
                            <td>A4, A5, A6</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ra3" value="1"></td>
                            <td><strong>RA3.</strong> Apoyar al médico veterinario en la preparación y aplicación de técnicas de preanestesia, anestesia y monitoreo de parámetros clínicos preoperatorio y postoperatorio.</td>
                            <td>A7, A8</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ra4" value="1"></td>
                            <td><strong>RA4.</strong> Observación, cuidado y seguimiento del paciente animal, registrando signos, evolución y cuidados indicados, promoviendo bienestar animal.</td>
                            <td>A8, A7</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ra5" value="1"></td>
                            <td><strong>RA5.</strong> Aplicar principios de seguridad, higiene y bioseguridad (incluida prevención de zoonosis) en el entorno de trabajo, utilizando EPP y procedimientos internos.</td>
                            <td>A9, A1</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ra6" value="1"></td>
                            <td><strong>RA6.</strong> Registrar y comunicar información técnica (historias clínicas, inventarios, reportes) con responsabilidad, ética y confidencialidad; participar en campañas sanitarias cuando aplique.</td>
                            <td>A10, A11</td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div class="note-box">
                    <strong>Nota.</strong> Marque con X los RA aplicables a este periodo, según el área asignada. Marque <strong>5-6 RA.</strong> Las actividades y la evaluación se alinean a los <strong>RA</strong> marcados.
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <ul class="activities-list">
                    <li><strong>A1.</strong> Preparación del paciente: sujeción segura, preparación de área, asepsia y apoyo en procedimientos indicados.</li>
                    <li><strong>A2.</strong> Aplicación de biológicos y medicamentos según prescripción (vías autorizadas en el establecimiento), con registro correspondiente.</li>
                    <li><strong>A3.</strong> Curaciones, vendajes, colocación de férulas y apoyo en manejo del dolor según indicación del médico veterinario.</li>
                    <li><strong>A4.</strong> Asistencia en procedimientos quirúrgicos: preparación de instrumental, campos, apoyo en esterilidad y conteo básico de material.</li>
                    <li><strong>A5.</strong> Apoyo en diagnóstico: toma y rotulación de muestras, preparación básica para análisis, manejo de cadena de custodia interna.</li>
                    <li><strong>A6.</strong> Apoyo en diagnóstico por imágenes (si aplica): preparación del paciente, seguridad radiológica básica y registro.</li>
                    <li><strong>A7.</strong> Apoyo en preanestesia/anestesia y monitoreo: registro de parámetros (T°, FC, FR, mucosas, etc.) y novedades al tutor.</li>
                    <li><strong>A8.</strong> Cuidados posoperatorios y hospitalización: higiene, alimentación, confort, observación y reporte de signos de alarma.</li>
                    <li><strong>A9.</strong> Aplicación de bioseguridad: limpieza, desinfección, manejo de residuos biológicos/punzocortantes según protocolos.</li>
                    <li><strong>A10.</strong> Registro y comunicación: historia clínica, reportes de turno/bitácora, control de inventarios y confidencialidad de la información.</li>
                    <li><strong>A11.</strong> Participación en campañas sanitarias (vacunación, desparasitación, educación sanitaria) cuando la entidad lo disponga.</li>
                </ul>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="note-box">
                    Las actividades son referenciales y podrán ajustarse según el nivel, curso, asignatura y planificación de la institución receptora, manteniendo coherencia con los resultados de aprendizaje seleccionados y con validación del tutor académico y tutor institucional.
                </div>
            </div>
