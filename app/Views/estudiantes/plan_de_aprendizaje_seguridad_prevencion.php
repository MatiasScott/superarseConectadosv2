    ...
    <div class="container">
        ...
        <div class="document-header">
            ...
            <div class="header-title">
                <h1>Gestión de Prácticas Pre Profesionales laborales7</h1>
        ...
        <form action="<?php echo $basePath; ?>/estudiante/generar-plan-aprendizaje-pdf" method="POST" id="planForm">
            ...
            <div class="form-section">
                ...
                <div class="objective-text">
                    Aplicar los conocimientos de Seguridad y Prevención de Riesgos Laborales mediante la ejecución de actividades técnicas de identificación, evaluación, control y mejora de riesgos en un entorno laboral real, bajo supervisión, fortaleciendo competencias profesionales, éticas, comunicacionales y de seguridad, en coherencia con el perfil de egreso de la carrera.
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <table class="results-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><strong>RA1.</strong> Aplicar la normativa vigente de seguridad y salud en el trabajo y la legislación aplicable, en el contexto de la entidad formadora.</td>
                            <td>A3, A7</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ra2" value="1"></td>
                            <td><strong>RA2.</strong> Identificar peligros y evaluar riesgos laborales, elaborando reportes y registros técnicos conforme a procedimientos internos.</td>
                            <td>A1, A2, A4</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ra3" value="1"></td>
                            <td><strong>RA3.</strong> Implementar medidas de prevención y control de riesgos (incluido el uso de EPP), contribuyendo a minimizar accidentes y enfermedades profesionales.</td>
                            <td>A2, A3</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ra4" value="1"></td>
                            <td><strong>RA4.</strong> Comunicar de forma clara procedimientos y hallazgos de seguridad, coordinando acciones con equipos de trabajo y actores involucrados.</td>
                            <td>A5, A4</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ra5" value="1"></td>
                            <td><strong>RA5.</strong> Participar en la planificación y/o ejecución de planes de emergencia, evacuación y conformación/fortalecimiento de brigadas.</td>
                            <td>A6</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ra6" value="1"></td>
                            <td><strong>RA6.</strong> Aplicar metodologías, modelos y técnicas de mejora continua para analizar datos e impulsar acciones preventivas en seguridad y salud ocupacional.</td>
                            <td>A8, A4</td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div class="note-box">
                    <strong>Nota.</strong> Marque con X los RA aplicables a este periodo, según el área asignada. Marque <strong>3-6 RA.</strong> Las actividades y la evaluación se alinearán a los <strong>RA</strong> marcados.
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <ul class="activities-list">
                    <li><strong>A1.</strong> Realizar inspecciones y recorridos de seguridad para identificar peligros (físicos, mecánicos, químicos, ergonómicos, psicosociales u otros) y registrar hallazgos.</li>
                    <li><strong>A2.</strong> Apoyar/ejecutar la evaluación de riesgos (matrices, listas de verificación u otras herramientas definidas por la entidad) y proponer medidas de control.</li>
                    <li><strong>A3.</strong> Verificar cumplimiento de uso de EPP y condiciones de seguridad básica; reportar desviaciones y apoyar en acciones correctivas.</li>
                    <li><strong>A4.</strong> Elaborar reportes técnicos (actas, informes, registros de inspección, incidentes/accidentes, capacitaciones), con trazabilidad y confidencialidad.</li>
                    <li><strong>A5.</strong> Participar en la socialización de procedimientos de seguridad, inducciones o capacitaciones internas, con comunicación clara y trato respetuoso.</li>
                    <li><strong>A6.</strong> Apoyar en la implementación o revisión de planes de emergencia, simulacros, rutas de evacuación y conformación/funcionamiento de brigadas.</li>
                    <li><strong>A7.</strong> Aplicar criterios de ergonomía y seguridad de la información en el manejo de documentos y datos sensibles de la entidad, cuando corresponda.</li>
                    <li><strong>A8.</strong> Identificar oportunidades de mejora y plantear una propuesta de mejora preventiva (simple y viable) basada en evidencias recogidas durante la práctica.</li>
                </ul>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="note-box">
                    Las actividades descritas en el presente plan son de carácter referencial y podrán adaptarse según la naturaleza, tamaño y procesos de la entidad formadora, siempre que mantengan coherencia con el perfil de egreso de la carrera y con los resultados de aprendizaje marcados, y cuenten con la validación del tutor académico.
                </div>
            </div>
