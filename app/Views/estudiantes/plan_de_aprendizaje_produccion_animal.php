    ...
    <div class="container">
        ...
        <form action="<?php echo $basePath; ?>/estudiante/generar-plan-aprendizaje-pdf" method="POST" id="planForm">
            ...
            <div class="form-section">
                ...
                <table class="results-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><strong>RA1.</strong> Ejecutar actividades técnicas de manejo productivo y reproductivo (según la especie), aplicando procedimientos establecidos y criterios de bienestar animal, bajo supervisión.</td>
                            <td>A1, A2, A6</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ra2" value="1"></td>
                            <td><strong>RA2.</strong> Implementar acciones preventivas de sanidad animal y bioseguridad conforme a protocolos internos y directrices de la autoridad sanitaria aplicables al contexto local, bajo supervisión.</td>
                            <td>A3, A8, A7</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ra3" value="1"></td>
                            <td><strong>RA3.</strong> Aplicar estrategias de alimentación y nutrición animal para mejorar el bienestar y productividad, utilizando recursos disponibles y siguiendo estándares técnicos de calidad.</td>
                            <td>A4, A1, A5</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ra4" value="1"></td>
                            <td><strong>RA4.</strong> Aplicar protocolos de buenas prácticas pecuarias y de sostenibilidad ambiental en las actividades diarias de la unidad productiva, promoviendo bienestar animal y uso eficiente de recursos.</td>
                            <td>A6, A3, A8</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ra5" value="1"></td>
                            <td><strong>RA5.</strong> Registrar y comunicar información técnica de la operación (producción, sanidad, alimentación, inventarios), utilizando herramientas y formatos institucionales, con responsabilidad y confidencialidad.</td>
                            <td>A5, A7</td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div class="note-box">
                    <strong>Nota.</strong> Marque con X los RA aplicables a este periodo, según el área asignada. Marque <strong>3-5 RA.</strong> Las actividades y la evaluación se alinean a los <strong>RA</strong> marcados.
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <ul class="activities-list">
                    <li><strong>A1.</strong> Ejecuta actividades de manejo y cuidado de animales (rutinas de alimentación, manejo, higiene y bienestar animal) bajo supervisión, cumpliendo normas internas de la unidad productiva.</li>
                    <li><strong>A2.</strong> Participa en labores de reproducción y manejo productivo (identificación, registros, control de condición corporal, apoyo en procedimientos programados), siguiendo protocolos técnicos establecidos.</li>
                    <li><strong>A3.</strong> Apoya en la aplicación de medidas preventivas de sanidad y bioseguridad (limpieza, desinfección, manejo de residuos, control de ingreso), actuando con responsabilidad y orden.</li>
                    <li><strong>A4.</strong> Colabora en la formulación o ajuste operativo de raciones o en el manejo de pastos y forrajes, registrando consumos y observaciones relevantes para el seguimiento productivo.</li>
                    <li><strong>A5.</strong> Realiza registros técnicos en formatos o sistemas internos (producción, consumo, tratamientos, inventarios), demostrando precisión, trazabilidad y confidencialidad.</li>
                    <li><strong>A6.</strong> Aplica buenas prácticas pecuarias, bienestar animal y criterios de sostenibilidad (uso eficiente de agua/insumos, manejo responsable de desechos), conforme a protocolos y normativa aplicable.</li>
                    <li><strong>A7.</strong> Elabora reportes simples de actividades y hallazgos (productivos/sanitarios/operativos) y comunica oportunamente novedades al tutor empresarial, con trato respetuoso y trabajo colaborativo.</li>
                    <li><strong>A8.</strong> Aplica normas básicas de seguridad y salud ocupacional (ergonomía, uso de EPP cuando corresponda, prevención de riesgos) durante el desarrollo de las actividades.</li>
                </ul>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="note-box">
                    Las actividades descritas en el presente plan son de carácter referencial y podrán adaptarse según la naturaleza, tamaño, especie(s) y procesos de la entidad formadora, siempre que mantengan coherencia con el perfil de egreso de la carrera de Producción Animal y cuenten con la validación del tutor académico.
                </div>
            </div>
