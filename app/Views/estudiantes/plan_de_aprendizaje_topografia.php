    ...
    <div class="container">
        ...
        <div class="document-header">
            ...
            <div class="header-title">
                <h1>Gestión de Prácticas Pre Profesionales laborales8</h1>
        ...
        <form action="<?php echo $basePath; ?>/estudiante/generar-plan-aprendizaje-pdf" method="POST" id="planForm">
            ...
            <div class="form-section">
                ...
                <div class="objective-text">
                    Aplicar los conocimientos de la carrera de Topografía en un entorno de campo y proyectos reales, mediante la ejecución de levantamientos topográficos, procesamiento de datos, elaboración de planos y apoyo en proyectos de georreferenciación, bajo supervisión, fortaleciendo competencias técnicas, éticas y de seguridad en obra, en coherencia con el perfil de egreso.
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <table class="results-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><strong>R1.</strong> Realizar levantamientos y replanteos topográficos (planimétricos y altimétricos) usando instrumentos y accesorios técnicos, conforme requerimientos y normas de obra.</td>
                            <td>A2, A3, A4</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ra2" value="1"></td>
                            <td><strong>R2.</strong> Procesar información topográfica según la precisión requerida del proyecto, aplicando criterios de control de datos (incluyendo análisis estadístico básico a partir de datos reales).</td>
                            <td>A5, A8</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ra3" value="1"></td>
                            <td><strong>R3.</strong> Representar información topográfica en planos: reconocer elementos gráficos y geométricos, calcular áreas y elaborar/leer planos en AutoCAD.</td>
                            <td>A6, A5</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ra4" value="1"></td>
                            <td><strong>R4.</strong> Utilizar herramientas tecnológicas y software (estación total, GNSS y SIG) para representaciones gráficas digitales e interpretación de planos topográficos.</td>
                            <td>A2, A6</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ra5" value="1"></td>
                            <td><strong>R5.</strong> Interpretar cartas topográficas y mapas temáticos para trabajos de georreferenciación.</td>
                            <td>A7</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ra6" value="1"></td>
                            <td><strong>R6.</strong> Aplicar seguridad en obra mediante la elaboración/implementación de planes de contingencia con medidas de prevención y protección técnica para evitar accidentes laborales.</td>
                            <td>A1, A2</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ra7" value="1"></td>
                            <td><strong>R7.</strong> Elaborar informes técnicos (planta y subterránea) sobre levantamientos e información, medir y representar en plano cumpliendo especificaciones técnicas.</td>
                            <td>A7, A6, A7</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ra8" value="1"></td>
                            <td><strong>R8.</strong> Representar fielmente el terreno (accidentes naturales y artificiales), sus límites y extensiones, mediante análisis para procesamiento y representación gráfica.</td>
                            <td>A3, A5, A6</td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div class="note-box">
                    <strong>Nota.</strong> Marque con X los RA aplicables a este periodo, según el área asignada. Marque <strong>3-7 RA.</strong> Las actividades y la evaluación se alinearán a los <strong>RA</strong> marcados.
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <ul class="activities-list">
                    <li><strong>A1.</strong> Apoyar en la planificación del levantamiento (reconocimiento, puntos de control, rutas, checklists de equipos y EPP).</li>
                    <li><strong>A2.</strong> Instalar, operar y verificar equipos (estación total, nivel, GNSS, accesorios), realizando controles básicos de precisión.</li>
                    <li><strong>A3.</strong> Ejecutar levantamientos topográficos (poligonales, radiaciones, nivelación u otros según proyecto) y registrar datos en libretas/formatos.</li>
                    <li><strong>A4.</strong> Participar en replanteos (ejes, cotas, alineamientos, estacas/puntos), documentando tolerancias y novedades para corrección.</li>
                    <li><strong>A5.</strong> Descargar, depurar y procesar datos (coordenadas, cotas, ajustes) y generar insumos técnicos para planos.</li>
                    <li><strong>A6.</strong> Elaborar/actualizar planos y productos gráficos (plantas, perfiles, secciones, curvas de nivel) en formato digital (CAD/SIG según aplique).</li>
                    <li><strong>A7.</strong> Apoyar en georreferenciación e interpretación cartográfica para ubicar elementos del proyecto y contrastar información.</li>
                    <li><strong>A8.</strong> Mantener bitácora y evidencias (archivos, capturas, reportes breves) y comunicar avances/incidencias al tutor empresarial y académico.</li>
                </ul>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="note-box">
                    Las actividades del presente plan son referenciales y podrán ajustarse según la naturaleza y procesos de la entidad formadora, manteniendo coherencia con el perfil de egreso y los RA seleccionados, con validación del tutor académico.
                </div>
            </div>
