            ...
            <form method="POST" action="<?= $formAction ?>" class="space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <select id="ejeSelect" class="w-full mt-1 border rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-purple-300 focus:border-purple-500">
                    ...
                    <div>
                        ...
                        <select id="objetivoSelect" name="objetivo_id" class="w-full mt-1 border rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-purple-300 focus:border-purple-500">
                    ...
                    <div>
                        ...
                        <select id="estrategiaSelect" name="estrategia_id" class="w-full mt-1 border rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-purple-300 focus:border-purple-500" required>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calcEjecucion() {
        ...
        const pct = Math.max(0, Math.min(100, Math.round(((p - e) / p) * 100)));
        const color = pct >= 70
        ...
        ejecBadge.textContent = '% Ejecucion Presupuestaria: ' + pct + '%';
