...
<div class="flex justify-between items-center mb-8">
    ...
    <a href="<?= $basePath ?>/admin/entidades"
        class="inline-flex items-center bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition font-semibold">
